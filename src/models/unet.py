...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, act_builder):
        ...
        self.act1 = act_builder(out_channels)  # 채널 수를 동적으로 주입하여 Activation 생성
...
class CustomUNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=3, features=[64, 128, 256, 512], act_builder=None):
        super().__init__()
    ...
    def _initialize_weights(self):
        """
        HeLU2d의 분산 보존 특성에 맞춰 모든 Conv 레이어를 Xavier(Glorot) 방식으로 초기화합니다.
        """
